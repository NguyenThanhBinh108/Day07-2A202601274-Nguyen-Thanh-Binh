...
| Trịnh Hải Đăng *(đã tự verify độc lập)* | `FixedSizeChunker(500, 50)` | 32 | #1 | **#1** | #1 | trượt | #1 | 2/5 | **6/10** |
...
| Thuyết trình (Demo)                        | chưa chấm — buổi demo chưa diễn ra tại thời điểm viết báo cáo này |

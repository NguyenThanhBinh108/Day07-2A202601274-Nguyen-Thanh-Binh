...
BENCHMARK = [
    {
        "id": 1,
        "query": "Người mua phải gửi yêu cầu đổi trả trong thời hạn nào?",
        "gold": "Trong thời hạn được nêu trên trang sản phẩm hoặc trong chính sách của sàn.",
        "gold_doc": "k4-returns-policy",
        "gold_snippet": "thời hạn được nêu trên trang sản phẩm",
        "filter": None,
    },
    {
        "id": 2,
        "query": "Khi hàng bị lỗi hoặc không đúng mô tả thì yêu cầu đổi trả cần kèm theo gì?",
        "gold": "Phải kèm bằng chứng phù hợp.",
        "gold_doc": "k4-returns-policy",
        "gold_snippet": "bằng chứng phù hợp",
        "filter": None,
    },
    {
        "id": 3,
        "query": "Người bán phải cung cấp những thông tin gì khi đăng bán sản phẩm?",
        "gold": "Thông tin sản phẩm chính xác, bao gồm giá, mô tả và tình trạng hàng.",
        "gold_doc": "k4-seller-listing",
        "gold_snippet": "giá, mô tả và tình trạng hàng",
        "filter": {"customer_role": "seller"},
    },
    {
        "id": 4,
        "query": "Những sản phẩm nào không được phép đăng bán trên sàn?",
        "gold": "Sản phẩm bị hạn chế hoặc bị cấm không được đăng bán.",
        "gold_doc": "k4-seller-listing",
        "gold_snippet": "hạn chế hoặc bị cấm",
        "filter": None,
    },
    {
        "id": 5,
        "query": "Người bán có trách nhiệm gì khi người mua gửi yêu cầu đổi trả?",
        "gold": "Người bán có trách nhiệm phản hồi theo quy trình của sàn.",
        "gold_doc": "k4-returns-policy",
        "gold_snippet": "phản hồi theo quy trình của sàn",
        "filter": None,
    },
]

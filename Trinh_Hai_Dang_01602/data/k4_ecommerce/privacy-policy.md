...
3.4. Nếu bạn không muốn chúng tôi thu thập thông tin/dữ liệu cá nhân nói trên, bạn có thể chọn không tham gia vào bất kỳ lúc nào bằng cách thông báo bằng văn bản đến Chuyên viên Bảo Vệ Dữ Liệu Cá Nhân của chúng tôi. Có thể tìm thấy thêm thông tin về nội dung trong mục "_Bạn có thể rút lại sự đồng ý, yêu cầu xóa, hạn chế xử lý, phản đối xử lý, yêu cầu cung cấp dữ liệu cá nhân, truy cập hoặc điều chỉnh thông tin bạn đã cung cấp cho chúng tôi bằng cách nào?_" dưới đây. Tuy nhiên, lưu ý rằng việc từ chối hoặc hủy bỏ cho phép chúng tôi thu thập, sử dụng hoặc xử lý dữ liệu cá nhân của bạn có thể ảnh hưởng đến việc bạn sử dụng Các Dịch Vụ và Nền tảng. Ví dụ như dịch vụ xác định vị trí sẽ không hoạt động nếu bạn không cho phép ứng dụng truy cập vị trí của bạn.
...
13.1._ _Rút Lại Sự Đồng Ý, Yêu cầu hạn chế, phản đối xử lý dữ liệu
...
13.2. _Yêu cầu cung cấp Dữ Liệu Cá Nhân_
...
13.3. _Yêu Cầu Truy Cập đến hoặc Sửa Dữ Liệu Cá Nhân_
